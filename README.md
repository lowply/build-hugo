...
- Utilizes [Hugo extended version 0.146.7](https://github.com/gohugoio/hugo/releases/tag/v0.146.7)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.146.7
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.146.7
```
