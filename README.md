...
- Using [Hugo extended version 0.123.7](https://github.com/gohugoio/hugo/releases/tag/v0.123.7)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.123.7
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.123.7
```
