...
- Using [Hugo extended version 0.124.1](https://github.com/gohugoio/hugo/releases/tag/v0.124.1)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.124.1
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.124.1
```
