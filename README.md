...
- Using [Hugo extended version 0.115.3](https://github.com/gohugoio/hugo/releases/tag/v0.115.3)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.115.3
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.115.3
```
