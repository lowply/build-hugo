...
- Using [Hugo extended version 0.130.0](https://github.com/gohugoio/hugo/releases/tag/v0.130.0)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.130.0
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.130.0
```
