...
- Using [Hugo extended version 0.112.4](https://github.com/gohugoio/hugo/releases/tag/v0.112.4)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.112.4
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.112.4
```
