...
- Using [Hugo extended version 0.120.3](https://github.com/gohugoio/hugo/releases/tag/v0.120.3)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.120.3
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.120.3
```
