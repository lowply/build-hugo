...
- Utilizes [Hugo extended version 0.158.0](https://github.com/gohugoio/hugo/releases/tag/v0.158.0)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.158.0
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.158.0
```
